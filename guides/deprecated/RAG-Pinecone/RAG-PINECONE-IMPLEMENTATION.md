...
1. The system generates embeddings using the configured model (default: text-embedding-3-large with 1024 dimensions)
...
- For OpenAI text-embedding-3-large: 1024 dimensions
