...
const perform = async (z: ZObject, bundle: Bundle): Promise<TaskFromEmailOutput> => {
  const inputData = bundle.inputData as unknown as TaskFromEmailInput;
  const { 
    emailId, 
    emailSubject, 
    emailFrom, 
