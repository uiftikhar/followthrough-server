...
const perform = async (z, bundle) => {
    ...
    const { originalEmailId, originalSubject, originalFrom, originalBody, replyTone, customInstructions, includeOriginal, priority } = inputData;
...
//# sourceMappingURL=draft-reply.js.map